...
/* Плотная раскладка: полная версия spectrum.s + загрузчик OPL4.
 * Проверяется build.bat: _CODE должен закончиться раньше _DATA,
 * а последняя секция — раньше 0xC000. */
#define VARIANT_DATA_LOC      0xB8DC
